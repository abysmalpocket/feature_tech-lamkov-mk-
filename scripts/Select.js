...
class Select extends BaseComponent{
  ...
  updateUI() {
    ...
    const updateButton = () => {
      ...
      this.buttonElement.setAttribute(this.steteAttributes.ariaExpanded, isExpanded)
      this.buttonElement.setAttribute(this.steteAttributes.ariaActiveDescendant, this.optionElements[currentOptionIndex].id)
    }
    ...
    const updateOptions = () => {
      this.optionElements.forEach((optionElement, index) => {
        ...
        optionElement.setAttribute(this.steteAttributes.ariaSelected, isSelected)
      })
    }
